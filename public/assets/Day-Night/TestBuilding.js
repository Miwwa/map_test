...
lib.ssMetadata = [
		{name:"TestBuilding_atlas_", frames: [[802,1806,600,539],[2406,602,800,600],[3208,602,800,600],[0,1806,800,600],[3208,1204,800,600],[1604,1204,800,600],[0,1204,800,600],[2406,1204,800,600],[802,1204,800,600],[1404,1806,600,539],[802,602,800,600],[3208,0,800,600],[1604,602,800,600],[0,0,800,600],[0,602,800,600],[802,0,800,600],[1604,0,800,600],[2406,0,800,600]]}
];
...
(lib.Tween1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.Night();
	this.instance.parent = this;
	this.instance.setTransform(-290,-295);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-290,-295,600,539);
...
(lib.TestBuilding = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(29).to({alpha:1},12).wait(63).to({alpha:0},13).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(41).to({alpha:1},63).to({alpha:0},13).wait(28));

	// Night
	this.instance_2 = new lib.Tween1("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(396,347.5);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({startPosition:0},24).to({alpha:1},31).to({startPosition:0},54).to({alpha:0},21).to({startPosition:0},14).wait(1));

	// Day
	this.instance_3 = new lib.Day();
	this.instance_3.parent = this;
	this.instance_3.setTransform(106,53);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TestBuilding_atlas_.png?1529479334679", id:"TestBuilding_atlas_"}
	],
	preloads: []
};

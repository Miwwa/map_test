...
lib.ssMetadata = [
		{name:"TestBuilding_atlas_", frames: [[802,1204,800,600],[802,1806,800,600],[1604,1806,800,600],[1604,1204,800,600],[1604,0,800,600],[802,2408,800,600],[1604,602,800,600],[802,3010,800,600],[1604,2408,600,539],[802,0,800,600],[0,2408,800,600],[802,602,800,600],[0,0,800,600],[0,3010,800,600],[0,602,800,600],[0,1204,800,600],[0,1806,800,600]]}
];
...
(lib.TestBuilding = function(mode,startPosition,loop) {
	...
	// Night
	this.instance_2 = new lib.Night();
	this.instance_2.parent = this;
	this.instance_2.setTransform(96,78);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(400,299,800,618);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/TestBuilding_atlas_.png?1529478856914", id:"TestBuilding_atlas_"}
	],
	preloads: []
};
